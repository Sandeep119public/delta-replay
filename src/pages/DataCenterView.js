...
function dashboard(snapshot, storage) {
...
function downloads(snapshot, download, dates) {
...
function validation(snapshot, validationState) {
...
function storage(snapshot, storageEstimate) {
