  ...
  <aside id="trading-panel" class="trading-section" aria-label="Paper trading panel">
    ...
    <div class="trading-top-summary" aria-label="Account snapshot">
      <div class="summary-main">
        ...
        <strong id="acct-equity">—</strong>
      </div>
      <div class="summary-side">
        <span class="summary-label">Unrealized P&amp;L</span>
        <strong id="acct-unrealized">—</strong>
      </div>
      ...
      <section id="order-ticket" class="order-ticket is-flat" aria-label="Order ticket">
        <div class="ticket-header">
          <div>
            ...
            <p id="ticket-state-hint" class="ticket-state-hint">FLAT • Pick a size</p>
          </div>
          <span id="pos-state-pill" class="pos-state-pill is-flat">FLAT</span>
        </div>

        <div class="ticket-field-grid">
          <label class="field field-wide">Order type
          ...
          <label class="field field-wide">Quantity
            <input id="trade-qty" inputmode="decimal" autocomplete="off" placeholder="0.00" aria-describedby="qty-notional">
            <span id="qty-notional" class="field-hint">≈ $0</span>
          </label>
          <label id="limit-price-row" class="field hidden">Limit price
            <input id="limit-price" inputmode="decimal" autocomplete="off" placeholder="0.00">
          </label>
          <label id="stop-price-row" class="field hidden">Stop price
            <input id="stop-price" inputmode="decimal" autocomplete="off" placeholder="0.00">
          </label>
        </div>
        ...
        <div class="side-actions" aria-label="Place order">
          <button id="btn-buy" class="order-action buy" type="button"><span>Buy / Long</span><kbd>1</kbd></button>
          <button id="btn-sell" class="order-action sell" type="button"><span>Sell / Short</span><kbd>2</kbd></button>
        </div>
        ...
        <div class="position-card">
          <div class="position-card-head">
            <div>
              ...
              <strong id="pos-symbol">No position</strong>
            </div>
            <span id="pos-side" class="position-side">—</span>
          </div>
          <div class="pos-compact-grid">
            <div><span>Size</span><strong id="pos-qty">—</strong></div>
            <div><span>Entry</span><strong id="pos-entry">—</strong></div>
            <div><span>Mark</span><strong id="pos-current">—</strong></div>
            <div><span>P&amp;L</span><strong id="pos-pnl">—</strong></div>
          </div>
          <div class="risk-grid">
            <label class="field">Stop loss<input id="sl-price" inputmode="decimal" placeholder="Optional"></label>
            <label class="field">Take profit<input id="tp-price" inputmode="decimal" placeholder="Optional"></label>
          </div>
          <div class="risk-actions">
            <button id="btn-set-risk" class="btn btn-secondary" type="button">Set risk</button>
            <button id="btn-clear-risk" class="btn btn-ghost" type="button">Clear</button>
          </div>
          <div class="current-risk">
            <span>SL <strong id="pos-sl">—</strong></span>
            <span>TP <strong id="pos-tp">—</strong></span>
          </div>
          <div id="ticket-flatten-summary" class="flatten-summary hidden">
            <div><span>Entry</span><strong id="flatten-entry">—</strong></div>
            <div><span>Mark</span><strong id="flatten-mark">—</strong></div>
            <div><span>P&amp;L</span><strong id="flatten-pnl" class="num">—</strong></div>
          </div>
    ...
    <div id="tab-view-account" class="tab-panel" role="tabpanel" aria-label="Account">
      <section class="account-card">
        <div class="account-stat"><span>Cash balance</span><strong id="acct-balance">—</strong></div>
        <div class="account-stat"><span>Realized P&amp;L</span><strong id="acct-realized">—</strong></div>
        <div class="account-stat"><span>Fees paid</span><strong id="acct-fees">—</strong></div>
      </section>
