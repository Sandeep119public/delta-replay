...
export function renderPaperLayout(mount) {
  ...
  if (mount.querySelector?.('#page-replay')) return mount.querySelector('#page-host') || mount.firstElementChild;
  mount.innerHTML = paperMarkup();
  return mount.querySelector('#page-host') || mount.firstElementChild;
}
