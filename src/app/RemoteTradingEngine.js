...
export class RemoteTradingEngine{
 ...
 async onMarketCandle(payload=null){this.latestCandle=payload?.candle||this.latestCandle;const body=payload?.candle?JSON.stringify({candle:payload.candle,index:payload.index??null}):undefined;return this._request('/candle',{method:'POST',...(body?{body}: {})})}
}