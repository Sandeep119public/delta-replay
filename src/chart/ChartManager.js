...
export class ChartManager {
  ...
  init(initialTheme = null) {
    ...
    if (!this.container || !this.container.isConnected) throw new Error('ChartManager requires connected chart-container element');
