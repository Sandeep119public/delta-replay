...
export class PaperTradingEngine extends EventEmitter {
  ...
  constructor({ startingBalance = 10000, feeRate = TRADING_CONFIG.TAKER_FEE_RATE, replayEngine = null, ambiguityPolicy = AMBIGUITY_POLICY.CONSERVATIVE, executionPolicy = null, realisticExecution = false, marginRate = 1.0, maintMarginRate = null, executionProfile = EXECUTION_PROFILE.MANUAL_REPLAY, executionTiming = null, fundingSchedule = null } = {}) {
    ...
    this._equityHistory = [this.account.startingBalance];
  ...
  _closePositionInternal(symbol, exitPrice, closedAt, exitReason = null, ambiguityResolution = 'NONE') {
    ...
    this._equityHistory.push(this.account.equity);
  ...
  getStatistics() { const perf = this.getPerformanceStats(); const snap = this.getAccountSnapshot(); return { equity: snap.equity, returnPct: perf.netReturn, totalTrades: perf.totalTrades, wins: perf.winningTrades, losses: perf.losingTrades, winRate: perf.winRate, netPnl: snap.realizedPnL, ...perf }; }
  getEquityHistory() { return (!this._equityHistory || this._equityHistory.length === 0) ? [this.account.startingBalance] : [...this._equityHistory]; }
