...
describe('Data center separation of concerns', () => {
  ...
  it('keeps the view free of data-service and application dependencies', () => {
    expect(view).not.toContain('DataWorkspacePort');
    expect(view).not.toContain('HistoricalDataManager');
